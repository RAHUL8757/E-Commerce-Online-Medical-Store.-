...
<body bgcolor="#671476">
	...
	<table width="700"align="center"border="1" bgcolor="#E8ECA3">
		<tr align="center">
		...
		<td><input type="text area"name="product_price"/></td>
		</tr>
		<tr>
...
if(isset($_POST['insert_product'])){
	...
	$product_cat=$_POST['product_cats'];
	...
	if($product_title=='' OR $product_cat=='' OR $product_brand=='' OR $product_desc==''
	  OR $product_keywords=='' OR $product_price=='' OR $product_img1==''){
		...
		$insert_products= "insert into products(cat_id,brand_id,date,product_title,product_img1,product_img2,product_img3,product_price,product_desc,product_status)value('$product_cat','$product_brand',NOW(),'$product_title','$product_img1','$product_img2','$product_img3','$product_price','$product_desc','$status')";
